...
//        sw.start();
	...
	/**
	 * 	Controla el accionamiento del click por el locator y expresi�n que se le pase.
	 * 	@param locator valores posibles:
	 * 	> LOCATOR_BY_CSS_SELECTOR
	 * 	> LOCATOR_BY_ID
	 * 	> LOCATOR_BY_XPATH
	 * 
	 * 	@param expression la expresi�n seg�n el tipo de locator
	 * 	@return element
	 * 	@throws Exception 
	 */
...
//			this.waitForAjax();
	...
	/**
	 *	Ejecuta un click en el n�mero de registro de la grilla de b�squeda que se le pasa.
	 * 	@param nroRegistro  
	 * 	@throws Exception 
	 */
	@Deprecated
...
//	 *	calendar en base a los par�metros.
//	 *	id: id del elemento
//	 *	String: n�mero de d�a a seleccionar
...
//	 * 	@param val : valor de la etiqueta con la que seleccionar� el elemento
//	 * 	@throws Exception	
//	 */
...
//
//	/**
//	 *	Permite fijar ingresar un texto a un elemento HTML input text � textarea.
//	 * 	@param id : id del elemento input
//	 * 	@param text : texto a ingresar en el elemento input text � textarea.
//	 * 	@throws Exception 
//	 */
...
//	}
	 ...
	 *	@param element : elemento en cuesti�n. 
	 */
